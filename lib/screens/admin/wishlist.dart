...
class HospitalWishlistPage extends StatefulWidget {
  final String hospitalName;

  const HospitalWishlistPage({
    Key? key,
    required this.hospitalName,
  }) : super(key: key);

  @override
  _HospitalWishlistPageState createState() => _HospitalWishlistPageState();
}

class _HospitalWishlistPageState extends State<HospitalWishlistPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: hospital.wishlistProducts.isEmpty
          ? const Center(
              child: Text('No products in wishlist'),
            )
          : ListView.builder(
              padding: const EdgeInsets.all(16),
              itemCount: hospital.wishlistProducts.length,
              itemBuilder: (context, index) {
                return ProductWishlistCard(
                  hospital: hospital,
                  product: hospital.wishlistProducts[index],
                );
              },
            ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Action icons - shopping cart icon and view details button removed
            Row(
              children: [
                const Spacer(),
